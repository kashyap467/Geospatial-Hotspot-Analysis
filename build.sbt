...
libraryDependencies ++= Seq(
  "org.apache.spark" %% "spark-core" % "2.4.0" % "compile" exclude("org.apache.hadoop", "*"),
  "org.apache.spark" %% "spark-sql" % "2.4.0" % "compile" exclude("org.apache.hadoop", "*"),
  "org.apache.hadoop" % "hadoop-mapreduce-client-core" % "2.7.2" % "compile",
  "org.apache.hadoop" % "hadoop-common" % "2.7.2" % "compile",
